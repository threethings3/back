		...
		resultActions.andExpect(status().isOk())
			.andDo(restDocs.document(requestHeaders(headerWithName("Authorization").description("AccessToken")),
				requestFields(fieldWithPath("challengeProfile.challengeCategory").description(
					...
					fieldWithPath("durationWeeks").description("챌린지 진행 주"),
		...
		resultActions.andExpect(status().isOk())
			.andDo(restDocs.document(requestHeaders(headerWithName("Authorization").description("AccessToken")),
				...
				responseFields(fieldWithPath("success").description("요청 성공 여부"),
					...
					fieldWithPath("result.data.contents[].durationWeeks").description("챌린지 진행 주간"),
		...
		resultActions.andExpect(status().isOk())
			.andDo(restDocs.document(requestHeaders(
				...
				responseFields(
					...
					fieldWithPath("result.data.durationWeeks").description("챌린지 진행 주간"),
